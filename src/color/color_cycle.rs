...
impl From<Qualitative> for ColorCycle {
    fn from(value: Qualitative) -> Self {
        match value {
            Qualitative::Tableau => ColorCycle::from(&ColorCyclesImpl::TABLEAU_B),
            Qualitative::Set3 => ColorCycle::from(&ColorBrewerQualitative::SET3),
        }
    }
}

// Cynthia Brewer https://colorbrewer2.org/
struct BrewerSequential;
...
impl BrewerSequential {
    ...
    const YL_GN : ([u32; 3], [u32; 4], [u32; 5], [u32; 6], [u32; 7], [u32; 8], [u32; 9]) = (
    ...
    const YL_GN_BU : ([u32; 3], [u32; 4], [u32; 5], [u32; 6], [u32; 7], [u32; 8], [u32; 9]) = (
    ...
    const GN_BU : ([u32; 3], [u32; 4], [u32; 5], [u32; 6], [u32; 7], [u32; 8], [u32; 9]) = (
    ...
    const BU_GN : ([u32; 3], [u32; 4], [u32; 5], [u32; 6], [u32; 7], [u32; 8], [u32; 9]) = (
    ...
    const PU_BU_GN : ([u32; 3], [u32; 4], [u32; 5], [u32; 6], [u32; 7], [u32; 8], [u32; 9]) = (
    ...
    const PU_BU : ([u32; 3], [u32; 4], [u32; 5], [u32; 6], [u32; 7], [u32; 8], [u32; 9]) = (
    ...
    const BU_PU : ([u32; 3], [u32; 4], [u32; 5], [u32; 6], [u32; 7], [u32; 8], [u32; 9]) = (
    ...
    const RD_PU : ([u32; 3], [u32; 4], [u32; 5], [u32; 6], [u32; 7], [u32; 8], [u32; 9]) = (
    ...
    const PU_RD : ([u32; 3], [u32; 4], [u32; 5], [u32; 6], [u32; 7], [u32; 8], [u32; 9]) = (
    ...
    const OR_RD : ([u32; 3], [u32; 4], [u32; 5], [u32; 6], [u32; 7], [u32; 8], [u32; 9]) = (
    ...
    const YL_OR_RD : ([u32; 3], [u32; 4], [u32; 5], [u32; 6], [u32; 7], [u32; 8], [u32; 9]) = (
    ...
    const YL_OR_BR : ([u32; 3], [u32; 4], [u32; 5], [u32; 6], [u32; 7], [u32; 8], [u32; 9]) = (
    ...
    const PURPLES : ([u32; 3], [u32; 4], [u32; 5], [u32; 6], [u32; 7], [u32; 8], [u32; 9]) = (
    ...
    const BLUES : ([u32; 3], [u32; 4], [u32; 5], [u32; 6], [u32; 7], [u32; 8], [u32; 9]) = (
...
impl BrewerDiverging {
    ...
    /// <div style="background-color: #542788; width: 10px; padding: 10px; border: 1px solid;"></div>
    /// <div style="background-color: #2d004b; width: 10px; padding: 10px; border: 1px solid;"></div>
    const OR_PU : ([u32; 3], [u32; 4], [u32; 5], [u32; 6], [u32; 7], [u32; 8], [u32; 9], [u32; 10], [u32; 11]) = (
    ...
    const BR_BG : ([u32; 3], [u32; 4], [u32; 5], [u32; 6], [u32; 7], [u32; 8], [u32; 9], [u32; 10], [u32; 11]) = (
    ...
    /// <div style="background-color: #00441b; width: 10px; padding: 10px; border: 1px solid;"></div>
    const PU_GN : ([u32; 3], [u32; 4], [u32; 5], [u32; 6], [u32; 7], [u32; 8], [u32; 9], [u32; 10], [u32; 11]) = (
    ...
    const PI_YG : ([u32; 3], [u32; 4], [u32; 5], [u32; 6], [u32; 7], [u32; 8], [u32; 9], [u32; 10], [u32; 11]) = (
    ...
    const RD_BU : ([u32; 3], [u32; 4], [u32; 5], [u32; 6], [u32; 7], [u32; 8], [u32; 9], [u32; 10], [u32; 11]) = (
    ...
    const RD_GY : ([u32; 3], [u32; 4], [u32; 5], [u32; 6], [u32; 7], [u32; 8], [u32; 9], [u32; 10], [u32; 11]) = (
    ...
    const RD_YL_BU : ([u32; 3], [u32; 4], [u32; 5], [u32; 6], [u32; 7], [u32; 8], [u32; 9], [u32; 10], [u32; 11]) = (
    ...
    /// <div style="background-color: #006837; width: 10px; padding: 10px; border: 1px solid;"></div>
    const RD_YL_GN : ([u32; 3], [u32; 4], [u32; 5], [u32; 6], [u32; 7], [u32; 8], [u32; 9], [u32; 10], [u32; 11]) = (
    ...
    /// <div style="background-color: #3288bd; width: 10px; padding: 10px; border: 1px solid;"></div>
    /// <div style="background-color: #5e4fa2; width: 10px; padding: 10px; border: 1px solid;"></div>
    const SPECTRAL : ([u32; 3], [u32; 4], [u32; 5], [u32; 6], [u32; 7], [u32; 8], [u32; 9], [u32; 10], [u32; 11]) = (
...
// Cynthia Brewer https://colorbrewer2.org/
struct ColorBrewerQualitative;

impl ColorBrewerQualitative {
...
struct ColorCyclesImpl;
    impl ColorCyclesImpl {
        ...
        // https://github.com/d3/d3-scale-chromatic/blob/main/src/
        const TABLEAU_B: [u32; 10] = [
            0x4e79a7, 0xf28e2c, 0xe15759, 0x76b7b2, 0x59a14f,
            0xedc949, 0xaf7aa1, 0xff9da7, 0x9c755f, 0xbab0ab,
        ];
    
        // https://github.com/d3/d3-scale-chromatic/blob/main/src/
        const D3_CATEGORY_10: [u32; 10] = [
            // <div style="background-color: #1f77b4"></div>
            0x1f77b4,
            // <div style="background-color: #ff7f0e"></div>
            0xff7f0e,
        ...
        // https://github.com/vega/vega/blob/main/packages/vega-scale/src/palettes.js
        const VEGA_CATEGORY_20 : [Color; 20] = [
            // <div style="background-color: #f17bec"></div>
            Color(0x1f77b4ff),
